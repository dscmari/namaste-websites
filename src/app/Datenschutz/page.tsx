...
export default function Datenschutz() {
  return (
    <div className="m-4 lg:mx-16 privacy">
      ...
      <p>
        Marian Nökel <br />
        Schlierseestrasse 10 <br />
        81541 München <br />
        Telefon: 015231432433 <br />
        E-Mail: noekel@namaste-websites.de
      </p>
      <p>
      ...
      <p className="my-4">Die Datenschutzerklärung zum Download im PDF-Format findetst du <a className="underline text-blue-500" href="./datenschutz_namaste-websites.pdf" target="_blank">hier</a>.</p>
    </div>
  );
}
