      ...
      <div className="lg:flex items-center gap-4">
        <div className="p-4 lg:w-2/3">
          ...
          <p>
            ...
            niedriger. Gerade, wenn es um mögliche Behandlungen für eine
            Erkrankung geht, fällt die Onlinerecherche leichter, als sich einem
            Bekannten oder einer Bekannten mit intimen Details anzuvertrauen.
          </p>
          <p>
            In der Heilkunde steht der Kranke in seiner ganzheitlichen
            Persönlichkeit im Mittelpunkt. Heilpraktiker:innen widmen sich
            intensiv ihren Patientinnen und Patienten, um ein möglichst
            umfassendes Bild zu zeichnen. Ihr Ziel ist es, mit
            naturheilkundlichen Verfahren ein ergänzendes oder alternatives
            Angebot zur Schulmedizin zu bieten und mit ihren Ansätzen das
            Spektrum der Therapievielfalt zu vergrößern.{" "}
          </p>
          <p>
            Hierfür müssen Heilpraktiker:innen ein Vertrauensverhältnis mit
            ihren Klient:innen schaffen und eng mit den erkrankten Menschen
            zusammenarbeiten.
          </p>
          <p>
            Der Heilpraktiker öffnet sich dem Patienten, nimmt ihn an, hört ihm
            zu. Er verknüpft und strukturiert seine Beobachtungen und das
            Berichtete mit seinen Erfahrungsmustern, um einerseits daraus sein
            therapeutisches Vorgehen abzuleiten und andererseits den Patienten
            über die Zusammenhänge seiner Probleme aufzuklären, sowie für eine
            aktive und mitverantwortliche Unterstützung bei den therapeutischen
          ...
          <p>
            ...
            Dinge sind extrem kostbar, da Menschen in Heilberufen lieber jede
            freie Minute in die detaillierte Anamnese und Behandlung ihrer
            Patient:innen investieren möchten.
          </p>
          ...
          <p>
            ...
            an der richtigen Adresse! Ich erstelle Dir schnell und unkompliziert
            Deinen Online-Auftritt. Und ich lassen den Stift nicht fallen,
            sobald die Internetseite das Licht der Welt erblickt, sondern helfe
            dir auch dabei, sie auf dem neuesten Stand zu halten. So kannst du
            deine Zeit voll und ganz deinen Klient:innen widmen. Den Rest
            erledige ich!
          </p>
          ...
          <p>
            ...
            Nutzerfreundlichkeit einer solchen Webseite im Zentrum stehen muss.
            Um deinen Klient:innen und dir Zeit zu sparen, sollte beispielsweise
            schnell ersichtlich werden, inwiefern oder ob Teile deiner
            Leistungen über die Krankenkasse abgerechnet werden können und wie
